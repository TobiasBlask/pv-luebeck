(function () {
  ...
  */
  var explainers = {
    ...
    widerspruchMuster: {
      cat: "Mixed Methods · Musterantwort", name: "Divergenz ist Information, nicht Fehler", mini: "consensus",
      tldr: "Widerspruch zwischen QUAL und QUANT nicht „auflösen“, sondern als Hinweis lesen. Meistens messen die beiden Verfahren auf unterschiedlichen Populationen, mit unterschiedlichen Konstrukten oder zu unterschiedlichen Momenten.",
      long: "Die häufigste Reaktion auf widersprüchliche Befunde ist, einen davon wegzumoderieren. Das ist methodisch der teuerste Fehler, weil gerade die Divergenz die analytisch wertvollste Information enthält. Vier Diagnose-Fragen helfen, den Widerspruch zu lesen: 1. Wer wurde gefragt? Die 88 % stammen aus einer breiten standardisierten Stichprobe, die zwölf Interviews aus einer gezielt rekrutierten Sub-Gruppe (z.B. Pendler:innen mit häufigem Anschluss-Verlust). 2. Was wurde gefragt? „Zufriedenheit“ auf einer 7-stufigen Skala vs. offene Erzählung über kritische Ereignisse misst unterschiedliche Konstrukte. 3. Wann wurde gefragt? Sofort nach Ankunft vs. Wochen später in der Nachreflexion. 4. Welche soziale Situation? Tablet-Befragung am Bahnsteig vs. 60-Minuten-Interview im Café. Wenn diese vier Punkte verschieden sind, sind beide Befunde wahr, aber über unterschiedliche Phänomene. Mixed-Methods-Praxis: die Divergenz als neues Forschungsobjekt behandeln und daraus schärfere Konstrukte oder feinere Segmentierungen ableiten.",
      example: "DB-Beispiel: 88 % Zufriedenheit (n = 2.500, Tablet, allgemein) plus zwölf frustrierte Pendler:innen (n = 12, Interview, 60 min, Anschluss-Verlust-Episoden). Diagnose: das eine misst Aggregat-Zufriedenheit der Gesamtpopulation, das andere den Mechanismus der akuten Sub-Gruppe Anschluss-Verlust. Beide stimmen, beschreiben aber unterschiedliche Phänomene.",
      figure: "<svg width='408' height='88' viewBox='0 0 408 88' xmlns='http://www.w3.org/2000/svg'><text x='90' y='14' font-family='DM Mono, monospace' font-size='10' font-weight='700' fill='#0f172a' text-anchor='middle'>QUANT</text><rect x='30' y='22' width='120' height='14' fill='#cbd5e1'/><rect x='30' y='22' width='106' height='14' fill='#0f172a'/><text x='90' y='52' font-family='DM Mono, monospace' font-size='9' fill='#0f172a' text-anchor='middle'>88 % zufrieden</text><text x='90' y='68' font-family='DM Mono, monospace' font-size='8' fill='#64748b' text-anchor='middle'>n = 2.500 · Tablet · allgemein</text><text x='204' y='34' font-family='DM Mono, monospace' font-size='18' font-weight='700' fill='#D9272E' text-anchor='middle'>≠</text><text x='204' y='52' font-family='DM Mono, monospace' font-size='9' fill='#D9272E' text-anchor='middle'>versch. Konstrukte</text><text x='318' y='14' font-family='DM Mono, monospace' font-size='10' font-weight='700' fill='#D9272E' text-anchor='middle'>QUAL</text><circle cx='270' cy='29' r='4' fill='#D9272E'/><circle cx='285' cy='29' r='4' fill='#D9272E'/><circle cx='300' cy='29' r='4' fill='#D9272E'/><circle cx='315' cy='29' r='4' fill='#D9272E'/><circle cx='330' cy='29' r='4' fill='#D9272E'/><circle cx='345' cy='29' r='4' fill='#D9272E'/><circle cx='360' cy='29' r='4' fill='#D9272E'/><circle cx='375' cy='29' r='4' fill='#D9272E'/><circle cx='270' cy='40' r='4' fill='#D9272E'/><circle cx='285' cy='40' r='4' fill='#D9272E'/><circle cx='300' cy='40' r='4' fill='#D9272E'/><circle cx='315' cy='40' r='4' fill='#D9272E'/><text x='318' y='60' font-family='DM Mono, monospace' font-size='9' fill='#D9272E' text-anchor='middle'>12 Frust-Episoden</text><text x='318' y='75' font-family='DM Mono, monospace' font-size='8' fill='#64748b' text-anchor='middle'>n = 12 · Interview · Sub-Gruppe</text></svg>",
      pitfall: "Falle: Wer den Widerspruch wegmoderiert („das war ja nur ein kleines Sample“), verliert die wertvollste Information. Divergenz ist Ausgangspunkt der nächsten Forschungsfrage."
    },
    variance: {
      cat: "Streuung", name: "Varianz · SD", mini: "se",
      tldr: "Varianz misst die mittlere quadratische Abweichung vom Mittelwert. Die Standardabweichung ist die Wurzel daraus, in der Maßeinheit der Daten. Beide beschreiben die Streuung der einzelnen Beobachtungen, nicht der Schätzung.",
      long: "Varianz s² und Standardabweichung s = √s² sind die zwei klassischen Streuungsmaße. Die Varianz hat den Vorteil, mathematisch sauber additiv zu sein (so wird in der Regression in „erklärte Varianz“ und „Residual-Varianz“ zerlegt, woraus R² entsteht). Die Standardabweichung hat den Vorteil, in derselben Einheit wie die Daten zu liegen (Minuten, Punkte, Euro). Aus der Standardabweichung wird der Standardfehler: SE = s / √n. Das heißt: SD beschreibt die Streuung der einzelnen Beobachtungen, SE beschreibt die Streuung der Schätzung über hypothetische Wiederholungen. Beide werden im Alltag häufig verwechselt, sind aber konzeptionell unterschiedliche Größen.",
      example: "Wartezeit-Messung bei n = 240 Reisenden: Mittelwert M̄ = 6,8 min, Standardabweichung s = 2,1 min, Varianz s² = 4,41 min². Daraus Standardfehler SE = 2,1 / √240 ≈ 0,14 min.",
      formal: "s² = Σ(x_i − x̄)² / (n − 1); s = √s²; SE = s / √n.",
      figure: "<svg width='408' height='88' viewBox='0 0 408 88' xmlns='http://www.w3.org/2000/svg'><line x1='20' y1='60' x2='388' y2='60' stroke='#cbd5e1' stroke-width='1'/><rect x='148' y='38' width='112' height='44' fill='#D9272E' fill-opacity='0.1'/><line x1='148' y1='34' x2='148' y2='86' stroke='#D9272E' stroke-width='1' stroke-dasharray='3 2'/><line x1='260' y1='34' x2='260' y2='86' stroke='#D9272E' stroke-width='1' stroke-dasharray='3 2'/><text x='204' y='30' font-family='DM Mono, monospace' font-size='11' font-weight='700' fill='#D9272E' text-anchor='middle'>±1 SD</text><circle cx='130' cy='62' r='3' fill='#0f172a' opacity='0.5'/><circle cx='154' cy='58' r='3' fill='#0f172a' opacity='0.7'/><circle cx='168' cy='62' r='3' fill='#0f172a' opacity='0.7'/><circle cx='184' cy='56' r='3' fill='#0f172a'/><circle cx='196' cy='62' r='3' fill='#0f172a'/><circle cx='204' cy='58' r='3' fill='#0f172a'/><circle cx='214' cy='64' r='3' fill='#0f172a'/><circle cx='226' cy='58' r='3' fill='#0f172a'/><circle cx='238' cy='62' r='3' fill='#0f172a' opacity='0.7'/><circle cx='254' cy='60' r='3' fill='#0f172a' opacity='0.7'/><circle cx='278' cy='62' r='3' fill='#0f172a' opacity='0.5'/><line x1='204' y1='40' x2='204' y2='72' stroke='#0f172a' stroke-width='2'/><text x='204' y='80' font-family='DM Mono, monospace' font-size='9' fill='#0f172a' text-anchor='middle'>M̄</text><text x='378' y='52' font-family='DM Mono, monospace' font-size='9' font-weight='600' fill='#0f172a' text-anchor='end'>s = 2,1 min</text><text x='378' y='66' font-family='DM Mono, monospace' font-size='9' fill='#64748b' text-anchor='end'>s² = 4,41 min²</text></svg>",
      pitfall: "Falle: SD ≠ SE. SD beschreibt die Streuung der Beobachtungen, SE die Streuung der Schätzung. Beide werden in Berichten oft vertauscht."
    },
    standardError: {
